...
const tr = {
  ...
  nav: { services: 'Hizmetler', approach: 'Yaklaşım', projects: 'Projeler', about: 'Hakkımızda', cta: 'Projenizi konuşalım', homeLabel: 'sryya.dev ana sayfa', menuLabel: 'Menüyü aç', navLabel: 'Ana menü', languageLabel: 'Dil seçimi' },
...
const en: typeof tr = {
  ...
  nav: { services: 'Services', approach: 'Approach', projects: 'Projects', about: 'About', cta: 'Let’s discuss your project', homeLabel: 'sryya.dev home page', menuLabel: 'Open menu', navLabel: 'Main navigation', languageLabel: 'Language selection' },
...
const ru: typeof tr = {
  ...
  nav: { services: 'Услуги', approach: 'Подход', projects: 'Проекты', about: 'О нас', cta: 'Обсудить проект', homeLabel: 'Главная страница sryya.dev', menuLabel: 'Открыть меню', navLabel: 'Главное меню', languageLabel: 'Выбор языка' },
